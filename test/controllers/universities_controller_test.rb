...
class UniversitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create university" do
    assert_difference('University.count') do
      post universities_url, params: { university: { city: @university.city, faculty_members: @university.faculty_members, name: @university.name, total_students: @university.total_students } }
    end
  ...
  test "should update university" do
    patch university_url(@university), params: { university: { city: @university.city, faculty_members: @university.faculty_members, name: @university.name, total_students: @university.total_students } }
